...
def load_tm(path):
    ...
    params = {
        "number_of_clauses": states["number_of_clauses"],
        "T": states["T"],
        "s": states["s"],
        "q": states["q"],
        "dim": states["dim"],
        "patch_dim": states["patch_dim"],
        "encode_loc": True,
        "seed": 10,
    }
...
def transform_Xs(tm: MultiClassConvolutionalTsetlinMachine2D, Xs: np.ndarray):
...
if __name__ == "__main__":
    ...
    tm = load_tm("./runs/pneumonia_mnist.tm")
