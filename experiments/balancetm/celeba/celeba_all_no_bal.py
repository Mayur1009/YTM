...
import numpy as np
from utils import load_celeba, encode_data, all_labels as label_names
...
PROJECT = "IMBALANCE"
NAME = f"celeba_no_bal_{datetime.now().strftime('%Y_%m_%d_%H_%M_%S')}"
DIR = f"./runs/celeba/{NAME}"
TAGS = ["celeba", "default", "all"]
GROUP = "celeba"
